...
if __name__ == "__main__":
    ...
    anno_path   = "/mnt/disk0/haoding/cholec80_original/labels/test_41-50/1fpsval_test.pickle"   # label
    data_root   = "/mnt/disk0/haoding/cholec80_original/frames"
    ckpt        = "/home/haoding/Wenzheng/Digital-Twin-based-Surgical-Phase-Recognition/GSViT/GSViT.pkl"     # gsvit
    out_dir     = "/mnt/disk0/haoding/cholec80_original/gsvit/test_41-50"              # 输出特征保存目录
    batch_size  = 16
    device      = "cuda:0"
