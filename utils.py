...
def save_model(
    ...
    if loss_scaler is not None:
        ...
        # Save as checkpoint-best
        best_checkpoint_path = output_dir / "checkpoint-best"
        model.save_checkpoint(
            save_dir=args.output_dir,
            tag="checkpoint-best",
            client_state=client_state,
...
def create_ds_config(args):
    ...
    if not os.path.exists(args.output_dir):
        os.makedirs(args.output_dir, exist_ok=True)  # Create the directory if it doesn't exist
